...
ListByUser(targetUserID string, limit, offset int, requestingUserID string) ([]*PostResponse, error) // requestingUserID for auth check
...
// ListByUser retrieves posts for a specific user, checking privacy against the requesting user
func (s *postService) ListByUser(targetUserID string, limit, offset int, requestingUserID string) ([]*PostResponse, error) {
posts, err := s.postRepo.ListByUser(targetUserID, limit, offset)
if err != nil {
