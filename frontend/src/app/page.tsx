    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-24 space-y-8">
        <div className="relative inline-block">
          ...
          <Heading level={1} className="relative text-6xl md:text-7xl font-bold mb-6 text-gray-900 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
            Connect in Your Own Space
          </Heading>
        </div>
        
        <Text className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          Join a social platform that values <span className="font-semibold text-purple-600">authentic connections</span> and <span className="font-semibold text-indigo-600">privacy-first design</span>. Share your world, discover communities, and engage in meaningful conversations.
        </Text>
            ...
            {features.map((feature, index) => (
              <div 
                ...
                className={`p-6 rounded-xl border border-gray-200 hover:border-purple-500 bg-white mx-4 transform transition-all duration-300 hover:scale-105 hover:z-10 group-hover:scale-100 group-hover:rotate-0 ${
                  ...
                  index % 2 === 0 ? 'rotate-2 origin-top' : '-rotate-2 origin-bottom'
                }`}
              >
      ...
      <div className="text-center mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-8 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 hover:shadow-lg transition-all">
            ...
            <Text className="text-gray-600">Full control over your data and visibility settings</Text>
          </div>
          ...
          <div className="p-8 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Vibrant Communities</h3>
            <Text className="text-gray-600">Join groups that match your interests and passions</Text>
          </div>
          ...
          <div className="p-8 rounded-xl bg-gradient-to-br from-pink-50 to-indigo-50 hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Instant Connection</h3>
            <Text className="text-gray-600">Real-time messaging and seamless communication</Text>
          </div>
        </div>
      </div>
      ...
      <div className="text-center bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 rounded-2xl p-12">
        ...
        <Text className="text-xl mb-8 max-w-2xl mx-auto text-gray-700">
          Join our vibrant community and experience a social network that puts you in control. Create, connect, and communicate your way.
        </Text>
        <Button
          href="/register"
...
const features = [
  {
    ...
    description: "Follow users and build your network with our intelligent request system that respects privacy preferences.",
    icon: (
  ...
  },
  {
    ...
    description: "Express yourself with customizable profiles featuring avatars, bios, and activity feeds.",
    icon: (
      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: "Dynamic Posts",
    description: "Share moments with text, images, and GIFs. Control who sees your content with flexible privacy options.",
    icon: (
      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: "Create and join groups, organize events, and engage with like-minded people in group discussions.",
    icon: (
      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
  ...
  },
  {
    ...
    description: "Connect instantly with private messaging, emoji support, and group chat rooms for seamless communication.",
    icon: (
      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: "Stay informed with real-time notifications for follows, group invites, and event updates.",
    icon: (
      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
